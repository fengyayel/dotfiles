...
scratchpad_user = {
    ...
    "scratchpad":"kitty -T scratchpad --class FloatingTerminal",
    # "scratchpad":"kitty -T scratchpad --class FloatingTerminal tmux",
    "scratchpad_term":"kitty -T scratchpad_term --class FloatingTerminal -o initial_window_width=130c -o initial_window_height=40c",
